  ...
  return (
    <div className="w-full max-w-md">
      <div className="relative p-8 space-y-6">
        {/* Watermark del logo, semi-trasparente, più grande della card rimossa: inglobiamo tutto il form */}
        <div className="absolute inset-0 z-0 flex items-center justify-center pointer-events-none select-none">
          <img
            src="/la-femme-logo.svg"
            alt=""
            aria-hidden="true"
            className="w-[150%] max-w-none h-auto opacity-[0.08] dark:invert"
          />
        </div>
        ...
        <div className="relative z-10 space-y-6">
          ...
          <div className="text-center space-y-1">
            <img
              src="/la-femme-logo.svg"
              alt="La Femme"
              className="h-[72px] w-auto mx-auto mb-4 dark:invert"
            />
